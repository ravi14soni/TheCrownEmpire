...
namespace Gpm.Common
{
    ...
    {
        public const string NETWORK_ERROR_MESSAGE =
            "Failed to send request. (Error has occurred in network.)";
        public const string PROTOCOL_ERROR_MESSAGE =
