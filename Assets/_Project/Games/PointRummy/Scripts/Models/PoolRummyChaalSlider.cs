...
public class PoolRummyChaalSlider : MonoBehaviour
{
    ...
    private PoolRummyConnection poolConnection;
    ...
    public void StartChaal()
    {
        ...
        poolConnection = obj.GetComponent<PoolRummyConnection>();
    ...
    public IEnumerator startchaalslider()
    {
        ...
        ischaal = true;
        if (poolConnection.waitforchaal)
        {
            poolConnection.waitforchaal = false;
    ...
    private void UpdateTimer()
    {
        ...
        float chaalTimer = poolConnection.chaaltimer;
    ...
    private void ResetChaal()
    {
        ...
        if (start)
        {
            ...
            if (
                ...
                && obj2.GetComponent<GameManager_Pool>().spawnedCards.Count == 14
            )
            {
    ...
    private void HandleGameManagerLogic()
    {
        ...
        {
            if (
                obj2.GetComponent<GameManager_Pool>().drawnard
                == obj2.GetComponent<GameManager_Pool>().finishdeskcard
            )
            {
        ...
        {
            obj2.GetComponent<GameManager_Pool>()
